...
class PaymentProvider(models.Model):
    ...
    def _get_payment_link(self, tx_sudo, **kwargs):
        ...
        payload = {
            ...
            'decline_url': f"{base_url}/payment/montypay/cancel?reference={order_number}&status=declined",
            'error_url': f"{base_url}/payment/montypay/cancel?reference={order_number}&status=error",
            'pending_url': f"{base_url}/payment/montypay/cancel?reference={order_number}&status=pending",
